...
3) ipset/get_antizapret.sh. быстро и без нагрузки на роутер получает лист с antizapret.prostovpn.org.
...
(ipv6, для новых LEDE и openwrt) opkg install kmod-ipt-raw6
